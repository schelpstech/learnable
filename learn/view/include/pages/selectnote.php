            ...
            <div class="col-md-3">
                <div class="white_card position-relative mb_20 ">
                    <div class="card-body">
                        ...
                        <div class="d-grid">
                            <a href="../../app/router.php?pageid=note&ref=<?php echo $list_note['noteid'] ?>" class="btn_2" style=" text-align:center;">Read this e-Note</a>
                        </div>
                    </div>
                </div>
            </div>
    <?php
        ...
        <div class="white_card position-relative mb_20 ">
            ...
            <i class="fas fa-ban " style="font-size:108px; color:red; text-align: center;"></i>
                <div class="row my-4">
                   <div class="col-auto">
                        <h4 class="text-dark mt-0">No Note Created for this subject Yet ' . $_SESSION['subjectid'] . '</h4>
                    </div>
                </div>
            </div>
        </div>
