...
?>
  ...
  ?></h2>
        ...
        <div class="container">
						...
						<form method="POST" action="verify.php" class="form-element-area" id="fupload" enctype="multipart/form-data">
							  ...
							  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" hidden="yes">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text"   class="form-control" name ="learner" placeholder="Full Name" value= "<?php
							echo $_SESSION['studnamed'];   // now, print the Session variable ?>">
                            ...
                            <div class="col-lg-8 col-md-4 col-sm-4 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <select type="text" class="form-control" required="yes" name="termd" id="term-list" required="yes" >
...
?>
							...
							<div class="col-lg-8 col-md-4 col-sm-4 col-xs-12">
                                <label>Learner's ID</label>
								<div class="form-group ic-cmp-int">
                                    <div class="form-ic-cmp">
                                        <i class="notika-icon notika-wifi"></i>
                                    </div>
                                    <div class="nk-int-st">
                                        <input type="text" disabled required="yes" class="form-control" name="learner1" value= "<?php echo $_SESSION['studnamed']; ?>">
                                    </div>
                                </div>
                            </div>
							
							<div class="col-lg-8 col-md-4 col-sm-4 col-xs-12">
                                <label>Term Pin</label>
								<div class="form-group ic-cmp-int">
                                    <div class="form-ic-cmp">
                                        <i class="notika-icon notika-wifi"></i>
                                    </div>
                                    <div class="nk-int-st">
                                        <input type="text" required="yes" maxlength="16" class="form-control" name="pin">
                                    </div>
                                </div>
                            </div>
							<br>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                       <input type="submit" class="form-control" name="verify" value="Check_Result"> 
                                    </div>
                                </div>
                            </div>
    ...
    <div id="doc" class="data-table-area">
        <div class="container">
            ...
            $count=1;
            $query=$conn->prepare("select * from archive WHERE learn = '$lname' AND status = '$val' ORDER BY rectime");
           ...
           $query->execute();
            ...
            <tr>
				...
				<td><?php echo $row->pinref ?></td>
				<td>
				    <a href="chkresult.php?loc=<?php echo $row->refdoc ?>&term=<?php echo $row->term?>" type="button"  class="btn btn-success" >Click to View Result</a>
				</td>
            </tr>
            <?php }?>
            </tbody>
