...
<head>
    ...
    <title>Make Payment - Learnable</title>
...
<?php include "nav.html"; ?>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2> Make Payment Online Now for  <?php echo $stname; ?>
  ...
  ?></h2>
        ...
        <div class="container">
						...
						<form method="POST" action="mkpayment.php" class="form-element-area" id="fupload" enctype="multipart/form-data">
...
<option value="<?php echo $term; ?>"><?php echo $term; ?></option>
							...
							<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" disabled required="yes" class="form-control" name="learner1" value= "<?php echo $stname. " - ".$_SESSION['studnamed']; ?>">
                                    </div>
                                </div>
                            </div>
							...
							<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input disabled type="text" required="yes" maxlength="16" class="form-control" name="pin" value ="-<?php echo -1 * (($paid - $bill) - $out); ?>">
                                    </div>
                                </div>
                            </div>
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="number" required="yes" min="100" class="form-control" name="amountpin">
                                    </div>
                                </div>
                            </div>
							<br>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                       <input type="submit" class="form-control" name="payful" value="Pay Online Now"> 
                                    </div>
                                </div>
                            </div>
