...
<head>
    ...
    <title>View Learning Materials for <?php echo  $_SESSION['subjected']." in ". $_SESSION['dclass'];?> - LearnAble</title>
...
?>
                        ...
                        <div class="view-mail-atn">
                           <br>
                           <iframe src="<?php echo"$notebook";?>" width="100%" height="800" allowfullscreen = "true" ></iframe>
