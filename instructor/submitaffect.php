...
$sql="INSERT INTO `lhpaffective` (term, uname, classid, total_present, rating1, rating2, rating3, rating4, rating5 ) VALUES ('$termid', '$learnerid', '$classid', '$present', '$lead', '$elo', '$neat', '$create', '$response')";
