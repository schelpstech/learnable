...
if ($status == 1){
    $butt = '<button type="button"  class="btn btn-success" >Termly Results Activated</button>';
}
if ($status == 0){
    $butt = '<button type="button"  class="btn btn-warning" >Termly Result Inactive</button>';
}
