...
<head>
    ...
    <title>Manage Learners - Learn at Home</title>
						...
						<form method="POST" action="edlearner.php" class="form-element-area" id="fupload" enctype="multipart/form-data">
							...
							<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                         <input type="password" minlength="8" maxlength="64" autocomplete="new-password" class="form-control" name="npwd" value="" placeholder="Leave blank to keep the current password">
