                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $query->fetch()) {
                                        ...
                                        if ($status == 1) {
                                            $butt = '<a disabled type="button"  class="btn btn-success" > Active </button>';
                                            $action = '<a href="termmodify.php?term='.$term .'" type="button"  class="btn btn-warning" > Deactivate Term</button>';
                                        }
                                        if ($status == 0) {
                                          $butt = '<a disabled type="button"  class="btn btn-primary" > Inactive </button>';
                                          $action = '<a href="termmodify.php?term='.$term .'" type="button"  class="btn btn-info" > Activate Term</button>';
                                        }
                                    ?>
                                        <tr>
