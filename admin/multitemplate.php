            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="normal-table-list mg-t-30">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="normal-table-list mg-t-30">
                                                                <div class="basic-tb-hd">
                                                                    <strong>
                                                                        <h3 style="text-align: center;">Performance
                                                                            Remarks</h3>
                                                                    </strong>
                                            ...
                                            <div class="breadcomb-list">
                                                <div class="row">
                                                    ...
                                                    <div class="breadcomb-icon">
                                                        <image src="../admin/archive/<?php echo $sign; ?>" height="100"
                                                            width="100" />
                        ...
                        <button id="cmd" onclick="generatePDF<?php echo $serial ?>()"
                            class="btn btn-default btn-icon-notika"><i class="notika-icon notika-down-arrow"></i>
